        ...
        <div name='about' className='w-full h-auto h-screen pt-24'>
            <div className='max-w-6xl mx-auto p-4 flex flex-col justify-center w-full h-full'>
                ...
                <div className="md:flex flex-col md:flex-row justify-between">
                    <div className="mt-5 space-y-8 md:w-1/2">
                    ...
                    <div className="md:w-1/2 p-5 md:pl-20">
                        <img className="hover:scale-110 w-full md:w-6/12 duration-500 rounded-xl" src="https://i.ibb.co/vDJx30T/image.png" alt="banner" />
                    </div>
                </div>
            </div>
        </div>
