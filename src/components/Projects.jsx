        ...
        <div className='max-w-6xl mx-auto px-5 pt-16 md:pt-24 max-h-screen'>
            <div>
                ...
                >
                    {/* slide-1 */}
                    <SwiperSlide>
                        <div id="slide1" className="carousel-item relative md:px-1 w-full">
                            ...
                            <div className="absolute rounded-xl flex items-center justify-end h-full hero-overlay bg-opacity-40">
                                <div className='text-white space-y-7 text-right pr-12'>
                                    <h2 className='md:text-4xl className  font-bold'>Brand Shop by React App</h2>
                                    <div>
                                        <a href="https://github.com/jasaiful/brand-shop-client.git" target="_blank" rel="noopener noreferrer">
                                            <button className="btn md:btn-md btn-sm btn-ghost hover:text-white outline outline-2 outline-rose-500 mr-5 md:text-lg hover:bg-rose-500">Code</button>
                                        </a>

                                        <a href="https://brand-shop-c7580.web.app/" target="_blank" rel="noopener noreferrer">
                                            <button className="btn md:btn-md btn-sm btn-ghost hover:text-white outline outline-2 outline-rose-500 mr-5 md:text-lg hover:bg-rose-500">Live</button>
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    {/* slide-2 */}
                    <SwiperSlide>
                        <div id="slide2" className="carousel-item relative md:px-1 w-full">
                            <img className="w-full rounded-xl" src='https://i.ibb.co/kxgSwtg/Fruit-Burst.jpg' alt="project_img" />
                            <div className="absolute rounded-xl flex items-center justify-end h-full hero-overlay bg-opacity-40">
                                <div className='text-white space-y-7 text-right pr-12'>
                                    <h2 className='md:text-4xl font-bold'>E-commerce Site by Tailwind CSS </h2>
                                    <div>
                    ...
                    {/* slide-3 */}
                    <SwiperSlide>
                        <div id="slide3" className="carousel-item relative md:px-1 w-full">
                            <img className="w-full rounded-xl" src='https://i.ibb.co/SvHBhvC/Course-Registration.jpg' alt="project_img" />
                            <div className="absolute rounded-xl flex items-center justify-end h-full hero-overlay bg-opacity-40">
                                <div className='text-white space-y-7 text-right pr-12'>
                                    <h2 className='md:text-4xl className  font-bold'>Course Registration Site by JavaScript</h2>
                                    <div>
                    ...
                    {/* slide-4 */}
                    <SwiperSlide>
                        <div id="slide4" className="carousel-item relative md:px-1 w-full">
                            <img className="w-full rounded-xl" src='https://i.ibb.co/w6k3cbT/Career-Center.jpg' alt="project_img" />
                            <div className="absolute rounded-xl flex items-center justify-end h-full hero-overlay bg-opacity-40">
                                <div className='text-white space-y-7 text-right pr-12'>
                                    <h2 className='md:text-4xl className  font-bold'>Career Site by React App</h2>
                                    <div>
                    ...
                    {/* slide-5 */}
                    <SwiperSlide>
                        <div id="slide5" className="carousel-item relative md:px-1 w-full">
                            <img className="w-full rounded-xl" src='https://i.ibb.co/5WCwqSv/Survey-Master.jpg' alt="project_img" />
                            <div className="absolute rounded-xl flex items-center justify-end h-full hero-overlay bg-opacity-40">
                                <div className='text-white space-y-7 text-right pr-12'>
                                    <h2 className='md:text-4xl className  font-bold'>Dynamic Survey Site by React</h2>
                                    <div>
