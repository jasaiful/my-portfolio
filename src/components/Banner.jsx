            ...
            <div className="md:relative hero w-full">
                ...
                <div className="md:absolute max-w-6xl mx-auto rounded-xl md:flex items-center justify-end h-full">
                    ...
                    <div className="md:w-1/2 space-y-5 mx-10">
                        <h3 className="text-rose-500 font-semibold text-3xl">Hello, I'm</h3>
                        <h1 className="text-6xl font-semibold mb-4">Julfiker Ali</h1>
                        <h5 className="text-2xl"> A Creative <span className="text-rose-500 font-semibold">Front-End Developer</span> From <span className="text-green-600 font-semibold">Bangladesh</span></h5>
